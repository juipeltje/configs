...
case $theme in
	Nordic)
		sed -i 's|^include ~/.config/sway/colors.*|include ~/.config/sway/colors-nordic.conf|' ~/repos/configs/workstation/home/dotconfig/sway/config
		...
		sed -i 's/^include.*/include = nordic-colors/' ~/repos/configs/common/home/dotconfig/tofi/config
                sed -i 's|^mako.*|mako -c ~/.config/mako/nordic-config \&|' ~/repos/configs/workstation/home/dotconfig/sway/autostart.sh
                sed -i 's|^waybar.*|waybar -c ~/.config/waybar/sway-config -s ~/.config/waybar/sway-style-nordic.css \&|' ~/repos/configs/workstation/home/dotconfig/sway/autostart.sh
		kill $(pgrep mako)
		kill $(pgrep waybar)
	...
	Gruvbox-Material-Dark)
                sed -i 's|^include ~/.config/sway/colors.*|include ~/.config/sway/colors-gruvbox-material-dark.conf|' ~/repos/configs/workstation/home/dotconfig/sway/config
		...
		sed -i 's/^include.*/include = gruvbox-material-dark-colors/' ~/repos/configs/common/home/dotconfig/tofi/config
                sed -i 's|^mako.*|mako -c ~/.config/mako/gruvbox-material-dark-config \&|' ~/repos/configs/workstation/home/dotconfig/sway/autostart.sh
                sed -i 's|^waybar.*|waybar -c ~/.config/waybar/sway-config -s ~/.config/waybar/sway-style-gruvbox-material-dark.css \&|' ~/repos/configs/workstation/home/dotconfig/sway/autostart.sh
		kill $(pgrep mako)
                kill $(pgrep waybar)
		...
		notify-send "Current theme: Gruvbox-Material-Dark"
                ;;
	Tokyo-Night)
                sed -i 's|^include ~/.config/sway/colors.*|include ~/.config/sway/colors-tokyonight.conf|' ~/repos/configs/workstation/home/dotconfig/sway/config
		...
		sed -i 's/^include.*/include = tokyonight-colors/' ~/repos/configs/common/home/dotconfig/tofi/config
                sed -i 's|^mako.*|mako -c ~/.config/mako/tokyonight-config \&|' ~/repos/configs/workstation/home/dotconfig/sway/autostart.sh
                sed -i 's|^waybar.*|waybar -c ~/.config/waybar/sway-config -s ~/.config/waybar/sway-style-tokyonight.css \&|' ~/repos/configs/workstation/home/dotconfig/sway/autostart.sh
                kill $(pgrep mako)
                kill $(pgrep waybar)
