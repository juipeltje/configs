...
case $theme in
	Nordic)
		...
		sed -i 's/^include.*/include = nordic-colors/' ~/repos/configs/common/home/dotconfig/tofi/config
                sed -i 's|^mako.*|mako -c ~/.config/mako/nordic-config \&|' ~/repos/configs/laptop/home/dotconfig/river/autostart.sh
                sed -i 's|^waybar.*|waybar -c ~/.config/waybar/river-config -s ~/.config/waybar/river-style-nordic.css \&|' ~/repos/configs/laptop/home/dotconfig/river/autostart.sh
		kill $(pgrep mako)
		kill $(pgrep waybar)
		...
		home-manager switch --flake ~/repos/configs/nixos#joppe@NixOS-Lappie --extra-experimental-features "nix-command flakes"
	...
	Gruvbox-Material-Dark)
		...
		sed -i 's/^include.*/include = gruvbox-material-dark-colors/' ~/repos/configs/common/home/dotconfig/tofi/config
                sed -i 's|^mako.*|mako -c ~/.config/mako/gruvbox-material-dark-config \&|' ~/repos/configs/laptop/home/dotconfig/river/autostart.sh
                sed -i 's|^waybar.*|waybar -c ~/.config/waybar/river-config -s ~/.config/waybar/river-style-gruvbox-material-dark.css \&|' ~/repos/configs/laptop/home/dotconfig/river/autostart.sh
		kill $(pgrep mako)
                kill $(pgrep waybar)
	...
	Tokyo-Night)
		...
		sed -i 's/^include.*/include = tokyonight-colors/' ~/repos/configs/common/home/dotconfig/tofi/config
                sed -i 's|^mako.*|mako -c ~/.config/mako/tokyonight-config \&|' ~/repos/configs/laptop/home/dotconfig/river/autostart.sh
                sed -i 's|^waybar.*|waybar -c ~/.config/waybar/river-config -s ~/.config/waybar/river-style-tokyonight.css \&|' ~/repos/configs/laptop/home/dotconfig/river/autostart.sh
                kill $(pgrep mako)
                kill $(pgrep waybar)
