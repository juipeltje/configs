...
#
# NixOS aliases
alias rebuild='sudo nixos-rebuild boot --flake ~/repos/configs/nixos#NixOS-Lappie'
alias rebuild-switch='sudo nixos-rebuild switch --flake ~/repos/configs/nixos#NixOS-Lappie'
alias update='sudo nix flake update --flake ~/repos/configs/nixos && sudo nixos-rebuild switch --flake ~/repos/configs/nixos#NixOS-Lappie'
