...
nord)
	...
	# helix
	sed -i --follow-symlinks 's/^theme.*/theme = "nord"/' ~/.config/helix/config.toml
...
gruvbox-dark)
	...
	# helix
	sed -i --follow-symlinks 's/^theme.*/theme = "gruvbox"/' ~/.config/helix/config.toml
...
tokyonight)
	...
	# helix
	sed -i --follow-symlinks 's/^theme.*/theme = "tokyonight"/' ~/.config/helix/config.toml
...
solarized-dark)
	...
	# helix
	sed -i --follow-symlinks 's/^theme.*/theme = "solarized_dark"/' ~/.config/helix/config.toml
...
catppuccin-mocha)
	...
	# helix
	sed -i --follow-symlinks 's/^theme.*/theme = "catppuccin_mocha"/' ~/.config/helix/config.toml
...
dracula)
	...
	# helix
	sed -i --follow-symlinks 's/^theme.*/theme = "dracula"/' ~/.config/helix/config.toml
