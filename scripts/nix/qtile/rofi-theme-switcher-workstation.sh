...
case $theme in
	Nordic)
		...
		sed -i 's/^@theme.*/@theme "nordic"/' ~/repos/configs/common/home/dotconfig/rofi/config.rasi
                sed -i 's|^dunst.*|dunst -conf ~/.config/dunst/dunstrc-nordic \&|' ~/repos/configs/workstation/home/dotconfig/qtile/autostart.sh
		kill $(pgrep dunst)
	...
	Gruvbox-Material-Dark)
		...
		sed -i 's/^@theme.*/@theme "gruvbox-material-dark"/' ~/repos/configs/common/home/dotconfig/rofi/config.rasi
                sed -i 's|^dunst.*|dunst -conf ~/.config/dunst/dunstrc-gruvbox-material-dark \&|' ~/repos/configs/workstation/home/dotconfig/qtile/autostart.sh
                kill $(pgrep dunst)
