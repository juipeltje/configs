...
alias sm='TMPDIR=/home/deck/tmp sudo nix --extra-experimental-features "nix-command flakes" run github:numtide/system-manager -- switch --flake ~/configs/nixos#Deckie'
